...
Setting.find_or_create_by(:namespace => 'datajam_chat', :name => 'bitly_username', :callbacks => ['update_bitly_login'])
Setting.find_or_create_by(:namespace => 'datajam_chat', :name => 'bitly_api_key', :callbacks => ['update_bitly_apikey'])
