...
_.bind(function(){new c.Views.ModeratorChat({el:g(this)})},this))});g(".chat-modal .modal-chat-controls").each(function(){i(["chat/views/chat_controls"],_.bind(function(){new c.Views.ChatControls({el:g(this)})},this))})})})})(jQuery,curl.define,curl);