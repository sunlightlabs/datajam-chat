(function(g,f,i){f("chat/common",[,"js!chat/vendor/underscore_mixins.js","js!chat/vendor/jquery.imagesloaded.js","js!chat/vendor/jquery.scrollTo-1.4.2-min.js","js!chat/vendor/moment.min.js"],function(){window.Datajam||(Datajam={});Datajam.Chat={Models:{},Views:{},Collections:{}};Datajam.Chat.csrf={csrf_param:g("meta[name=csrf-param]").attr("content"),csrf_token:g("meta[name=csrf-token]").attr("content")};g("document").bind("csrfloaded",function(){Datajam.Chat.csrf.csrf_token=g("meta[name=csrf-token]").attr("content")})});
f("chat/upload",["js!chat/vendor/jquery.form.js"],g.noop);f("chat/tweet",["js!//platform.twitter.com/widgets.js"],g.noop);f("chat/collections/message",["chat/common"],function(){var c=jQuery;Datajam.Chat.Collections.Message=Backbone.Collection.extend({add:function(b,d){_.isArray(b)?c.each(b,_.bind(function(a,b){b=this._clean(b);this.add_or_replace(b,d)},this)):(b=this._clean(b),this.add_or_replace(model,d));return this},add_or_replace:function(b,c){var a=this.get(b.id);a?b.updated_at>a.get("updated_at")&&
...
initialize:function(){},parse:function(c){c.chat.id=c.chat._id;delete c.chat._id;c=c.chat;c._submit_url=this.url.replace(".json","/messages/");return c}})});f("chat/views/message",["text!chat/templates/message/show.html","chat/common","chat/tweet","js!chat/vendor/md5.js","chat/models/message"],function(c){var b=jQuery,d=Datajam.Chat;d.Views.Message=Backbone.View.extend({linkP:/https?:\/\/[\w\-\/#\.%\?=&:,|]+[\w\-\/#=&]/g,imageP:/\.(jpe?g|gif|png|bmp|tiff?)$/,events:{click:"handleClick"},tagName:"li",
